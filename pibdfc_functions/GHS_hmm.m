...
function [omega_save,Sigma_save, lambda_sq_save,tau_sq_save, xi_save, Nu_save] = GHS_hmm(S,Omega, Sigma, Lambda_sq, tau_sq, Nu, xi, n, tau_0)
...
%     tau_0: scale for the prior of tau, the global scale parameter
...
%%% sample tau_sq and xi
    ...
    xi = 1/gamrnd(1,1/(1/tau_0 + 1/tau_sq));      % inv gamma w/ shape=1, rate=1/tau_0+1/tau_sq
%%% save Omega, lambda_sq, tau_sq          
         omega_save = Omega;
         lambda_sq_save = Lambda_sq;
         tau_sq_save = tau_sq;
         xi_save = xi;
         Nu_save = Nu;
         Sigma_save = Sigma;
